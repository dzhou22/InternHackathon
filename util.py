...
def ask_question_OLD(handler_input):
    # (HandlerInput) -> None
...
def ask_question(handler_input):
    attr = handler_input.attributes_manager.session_attributes
    # ask the attr["counter"]-th question
    logger.info("ASKING CUSTOM QUESTION")
    question = data.QUESTIONS_LIST[attr["counter"]]
